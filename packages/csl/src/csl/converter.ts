// import { csl } from '.';
// import { LANGUAGE_VERSIONS, POLICY_ID_LENGTH, REDEEMER_TAGS } from '@mesh/common/constants';
// import {
//     deserializeDataHash,
...
//                 (key) =>
//                     LANGUAGE_VERSIONS[key].to_hex() === plutusScript.language_version().to_hex(),
//             ),
//         };
//     }
...
// export const toValue = (assets: Asset[]): csl.Value => {
