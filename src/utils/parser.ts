...
export const serializeBech32Address = (bech32Addr: string): { pubKeyHash: string, scriptHash: string, stakeCredential: string } => {
  const cslAddress: csl.BaseAddress | undefined = csl.BaseAddress.from_address(csl.Address.from_bech32(bech32Addr))
