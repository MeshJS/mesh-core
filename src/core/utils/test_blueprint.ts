...
//     flags.npm ? 'lucid-cardano' : `https://deno.land/x/lucid@${packageJson.version}/mod.ts`
// }"`;
...
// function generateTypes(blueprint: Blueprint): Record<string, ValidatorTypes> {
//     const definitions = blueprint.definitions;

//     const validators: Record<string, ValidatorTypes> = {};

//     blueprint.validators.forEach((validator) => {
//         const datumType = resolveSchema(validator.datum, definitions);
//         const redeemerType = resolveSchema(validator.redeemer, definitions);
//         const parameterType = resolveSchema(validator.parameter, definitions);

//         validators[validator.name] = {
//             datum: schemaToType(datumType),
//             redeemer: schemaToType(redeemerType),
//             parameter: schemaToType(parameterType),
//         };
//     });
